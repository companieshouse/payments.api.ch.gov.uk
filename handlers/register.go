...
// only want to create 1 istance of this service for all handlers to use
// so store it here in the handlers package where it's available to them and created in the main Register func
