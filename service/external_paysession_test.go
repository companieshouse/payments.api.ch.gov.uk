...
func TestUnitCreateExternalPayment(t *testing.T) {
	...
	Convey("Invalid payment method", t, func() {
		...
		mock.EXPECT().GetPaymentResource("1234").Return(&models.PaymentResourceDB{ID: "1234", Data: models.PaymentResourceData{Amount: "10.00", Links: models.PaymentLinksDB{Resource: "http://dummy-resource"}, PaymentMethod: "PayPal"}}, nil)
	...
	Convey("Error response from GovPay", t, func() {
		...
		mock.EXPECT().GetPaymentResource("1234").Return(&models.PaymentResourceDB{ID: "1234", Data: models.PaymentResourceData{Amount: "10.00", Links: models.PaymentLinksDB{Resource: "http://dummy-resource"}, PaymentMethod: "GovPay"}}, nil)
