...
// PaymentTransformer transforms pyment resource data between rest and database models
...
func (pt PaymentTransformer) transformCreatedBy(rest models.CreatedByRest) models.CreatedBy {
	return models.CreatedBy{
		Email:    rest.Email,
		Forename: rest.Forename,
		ID:       rest.ID,
