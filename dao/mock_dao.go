...
func (m *MockDAO) CreateBulkRefundByExternalPaymentTransactionID(providerID string, bulkRefund models.BulkRefundDB) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateBulkRefundByExternalPaymentTransactionID", providerID, bulkRefund)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockDAOMockRecorder) CreateBulkRefundByExternalPaymentTransactionID(providerID, bulkRefund interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateBulkRefundByExternalPaymentTransactionID", reflect.TypeOf((*MockDAO)(nil).CreateBulkRefundByExternalPaymentTransactionID), providerID, bulkRefund)
}

// CreateBulkRefundByProviderID mocks base method.
func (m *MockDAO) CreateBulkRefundByProviderID(providerID string, bulkRefund models.BulkRefundDB) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateBulkRefundByProviderID", providerID, bulkRefund)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateBulkRefundByProviderID indicates an expected call of CreateBulkRefundByProviderID.
func (mr *MockDAOMockRecorder) CreateBulkRefundByProviderID(providerID, bulkRefund interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateBulkRefundByProviderID", reflect.TypeOf((*MockDAO)(nil).CreateBulkRefundByProviderID), providerID, bulkRefund)
}
